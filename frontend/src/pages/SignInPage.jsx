...
import { Cpu, Lock, Mail, Loader2, ArrowRight, Github, ExternalLink, ArrowLeft, Key } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-[#0B1020] border border-surfaceBorder rounded-3xl shadow-2xl p-8 relative z-10 animate-in fade-in zoom-in-95 duration-150">
        <div className="flex flex-col items-center text-center space-y-2 mb-6">
          ...
          <h1 className="text-xl font-bold text-white tracking-tight">
            {configProvider ? `Configure ${configProvider} OAuth` : 'Sign in to Architect'}
          </h1>
          <p className="text-xs text-slate-400">
            {configProvider ? 'Direct official OAuth redirection' : 'Welcome back! Enter your developer credentials.'}
          </p>
        </div>
